...
export const name = (id = '2', title, store = false) =>
  chargeLRS(id, typeObject(id).concat(sTitle(id, title)), store);

export const fullCW = (id = '3', attrs = {}, store = false) =>
  chargeLRS(id, sFull(id, attrs), store);
