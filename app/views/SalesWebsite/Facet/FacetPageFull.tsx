...
const FacetPageFull: FC = () => {
  ...
  const [moreTitle] = useProperty(sales.ns('moreTitle'));
  const [moreDescription] = useProperty(sales.ns('moreDescription'));
  const [morePageName] = useProperty(sales.ns('morePageName'));
  const [morePageLink] = useProperty(sales.ns('morePageLink'));
