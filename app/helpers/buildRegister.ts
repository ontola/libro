...
export const buildRegister = <P>(baseMap: RegistrationOpts<any>) => {
  return (comp: React.ComponentType<P>, overrides: Partial<RegistrationOpts<any>>): Array<ComponentRegistration<React.ComponentType<any>>> => (
