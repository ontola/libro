...
export const MAPBOX_TILE_API_BASE = getEnv('MAPBOX_TILE_API_BASE', 'https://api.mapbox.com/styles/v1', '');
export const MAPBOX_TILE_STYLE = getEnv('MAPBOX_TILE_STYLE', 'mapbox/streets-v11', '');
